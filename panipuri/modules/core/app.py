...
class App(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("Bae_wafaaa")
                await self.one.join_chat("Akimaxmovies")
                await self.one.join_chat("She2Feelz")
            except:
                pass
            assistants.append(1)
            try:
                await self.one.send_message(
                    config.LOG_GROUP_ID,
                    f"**━━━━━━━━━━━━━━━━━━━**\n**✅ 𝐀𝐬𝐬𝐢𝐬𝐭𝐚𝐧𝐭 𝟏 𝐇𝐚𝐬 𝐒𝐭𝐚𝐫𝐭𝐞𝐝 🥳**\n**━━━━━━━━━━━━━━━━━━━**\n**🥀 𝐍𝐚𝐦𝐞 ›** {self.one.name}\n**🌸 𝐋𝐢𝐧𝐤 : ›** @{self.one.username}\n**🌷 𝐈𝐃✩ : ›** `{self.one.id}`\n**━━━━━━━━━━━━━━━━━━━**\n**🔥 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 : [पानीपुरी 2.0 𝐒𝐞𝐫𝐯𝐞𝐫](https://t.me/Bae_wafaaa).**\n**━━━━━━━━━━━━━━━━━━━**",
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("Bae_wafaaa")
                await self.two.join_chat("Akimaxmovies")
                await self.two.join_chat("She2Feelz")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("Bae_wafaaa")
                await self.three.join_chat("Akimaxmovies")
                await self.three.join_chat("She2Feelz")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("Bae_wafaaa")
                await self.four.join_chat("Akimaxmovies")
                await self.four.join_chat("She2Feelz")
            except:
                pass
            assistants.append(4)
            try:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("Bae_wafaaa")
                await self.five.join_chat("Akimaxmovies")
                await self.five.join_chat("She2Feelz")
            except:
                pass
            assistants.append(5)
            try:
